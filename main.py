...
def main(params):
    ...
    if params.loss == 'arcface':
        ...
        basic_model = 'GhostFaceNetV1-1.3-1-ArcFace.h5'
    else:
        save_path = os.path.join(params.work_dir, 'ghostV1-1.3-1-(C).h5')
        basic_model = 'GhostFaceNetV1-1.3-1-CosFace.h5'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, required=True, help='Path to the train.csv')
    parser.add_argument('--output', type=str, default='work_dir', help='Path to the working directory.')
